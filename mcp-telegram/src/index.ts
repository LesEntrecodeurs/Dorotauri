 ...
 * Works independently - reads config from ~/.dorotoring/settings.json and sends directly to Telegram.
 */
...
// Settings file path
const SETTINGS_FILE = path.join(os.homedir(), ".dorotoring", "app-settings.json");
