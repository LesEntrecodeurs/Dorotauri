...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::ssh::ssh_list_host_groups,
            commands::ssh::ssh_create_host_group,
            commands::ssh::ssh_update_host_group,
            commands::ssh::ssh_delete_host_group,
            commands::ssh::ssh_move_host_to_group,
