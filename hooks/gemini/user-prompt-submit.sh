#!/bin/bash
# UserPromptSubmit hook for dorotoring (Gemini CLI)
...
echo "[$(date)] GEMINI USER_PROMPT_SUBMIT hook. AGENT_ID=${DOROTORING_AGENT_ID:-unset} SESSION_ID=$SESSION_ID" >> /tmp/dorotoring-hooks.log
