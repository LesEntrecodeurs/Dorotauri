...
echo "[$(date)] STOP hook. AGENT_ID=${CLAUDE_AGENT_ID:-unset} SESSION_ID=$SESSION_ID STOP_ACTIVE=$STOP_HOOK_ACTIVE" >> /tmp/dorotoring-hooks.log
...
echo "[$(date)] STOP curl result: $RESULT" >> /tmp/dorotoring-hooks.log
