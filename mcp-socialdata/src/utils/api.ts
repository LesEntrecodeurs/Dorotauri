...
function getApiKey(): string {
  const settingsPath = path.join(os.homedir(), ".dorotoring", "app-settings.json");
  try {
  ...
  throw new Error(
    "SocialData API key not configured. Please add your API key in Dorotoring Settings > SocialData."
  );
}
