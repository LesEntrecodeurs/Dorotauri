...
const CommitItem = memo(function CommitItem({
  ...
  return (
    <div className="px-3 py-2 border-b border-border/50 last:border-0 hover:bg-muted/30">
...
const FileStatusItem = memo(function FileStatusItem({
  ...
  const getStatusIcon = () => {
    switch (item.status) {
      ...
      default:
        return <FileDiff className="w-3 h-3 text-muted-foreground shrink-0" />;
    }
  };
  ...
  return (
    <div className="flex items-center gap-2 px-3 py-1.5 text-xs hover:bg-muted/30">
      {getStatusIcon()}
    ...
    <div className={`flex flex-col bg-[#0d0d14] overflow-hidden ${className}`}>
      ...
      {loading && gitData.status.length === 0 ? (
        ...
        <div className="flex-1 flex flex-col min-h-0 overflow-hidden">
          {/* Changed Files */}
          <div className="flex-1 flex flex-col min-h-0 overflow-hidden">
            <div className="px-3 py-2 bg-muted/20 shrink-0">
            ...
            {gitData.status.length === 0 ? (
              <div className="px-3 py-3 text-xs text-muted-foreground text-center">No changes</div>
            ) : (
          ...
          <div className="shrink-0 border-t border-border">
            <button
              ...
              className="w-full px-3 py-2 bg-muted/20 flex items-center justify-between hover:bg-muted/40 transition-colors"
            >
              <div className="flex items-center gap-2 text-xs font-medium text-muted-foreground">
            ...
            {showCommits && (
              <>
                {gitData.commits.length === 0 ? (
                  <div className="px-3 py-4 text-xs text-muted-foreground text-center">No commits</div>
                ) : (
