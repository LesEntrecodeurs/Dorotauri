    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardContent className="p-6">
          <div className="space-y-6">
            <div>
              <Label className="block mb-3">Allowed Permissions</Label>
            ...
            <div>
              <Label className="block mb-3">Denied Permissions</Label>
              <div className="p-4 bg-secondary border border-border min-h-[80px]">
                {settings?.permissions?.deny && settings.permissions.deny.length > 0 ? (
                  <div className="flex flex-wrap gap-2">
                    {settings.permissions.deny.map((perm, i) => (
                      <span
                        key={i}
                        className="px-2 py-1 bg-red-500/20 text-destructive text-xs font-mono"
                      >
                        {perm}
                      </span>
                    ))}
