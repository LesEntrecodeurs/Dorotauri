  ...
  return (
    <div
      className={`
        absolute z-10 group
        ${type === 'col'
          ? 'top-0 bottom-0 w-1 cursor-col-resize hover:bg-primary/30'
          : 'left-0 right-0 h-1 cursor-row-resize hover:bg-primary/30'
        }
      `}
    ...
    >
      <div
        className={`
          absolute bg-primary/0 group-hover:bg-primary/50 transition-colors
